/**
 * OnboardingChecklist/AddBeneficiaryStep.tsx
 * What it does: Renders the "Add a Beneficiary" checklist step with its link, icons, and descriptions.
 * What it owns: The presentation and interaction states for the Beneficiary step in the onboarding list.
 * What it does NOT do: Does not fetch beneficiary state directly (provided as props from the parent).
 */
...
interface AddBeneficiaryStepProps {
  isComplete: boolean;
}

export default function AddBeneficiaryStep({ isComplete }: AddBeneficiaryStepProps) {
  return (
    <Link
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-xs text-gray-500 dark:text-gray-400 leading-normal">
          Appoint a nominee to safely inherit your secured data.
        </span>
      </div>
    </Link>
  );
