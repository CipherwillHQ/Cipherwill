  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <MdEmail className="text-clay text-xl min-w-[24px]" />
        <p className="text-sm text-gray-700 dark:text-gray-300">
          Please verify your email to access all features and secure your account.
        </p>
      </div>
      <Link
        className="bg-primary hover:bg-primary-700 text-white text-sm px-4 py-2 rounded-full font-medium transition-colors duration-200 flex items-center gap-2 text-center"
