    ...
    <section className="py-12 sm:py-16 lg:py-20 ">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-gray-100 sm:text-4xl xl:text-5xl">
            How it works
          </h1>
        ...
        <div className="flex flex-col items-center max-w-md mx-auto mt-8 lg:mt-20 lg:flex-row lg:max-w-none">
          <div className="relative flex-1 w-full overflow-hidden bg-neutral-50 dark:bg-[#0E0E0E] border border-gray-600 rounded-2xl">
            <div className="py-8 px-9">
              ...
              <p className="mt-5 text-xl font-medium text-neutral-800 dark:text-gray-300 ">
                Sign up and create your first note for your beneficiary
              </p>
            </div>
          </div>
          ...
          <div className="relative flex-1 w-full">
            ...
            <div className="relative overflow-hidden bg-neutral-50 dark:bg-[#0E0E0E] border border-gray-600 rounded-2xl">
              <div className="py-8 px-9">
                <div className="inline-flex items-center justify-center w-10 h-10 text-base font-bold text-white bg-gray-900 rounded-xl ">
                  2
                </div>
                <p className="mt-5 text-xl font-medium text-neutral-800 dark:text-gray-300 ">
                  Add your loved ones as beneficiaries and friends
                </p>
              </div>
            </div>
          </div>
