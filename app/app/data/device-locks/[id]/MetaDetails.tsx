  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-2 justify-between py-2">
        ...
        <div
          ...
          onBlur={(e) => {
            ...
            if (new_name.length === 0) {
              document.getElementById("device-lock-name").innerText = parsedData.name;
            }
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter") {
              e.preventDefault();
              e.stopPropagation();
              document.getElementById("device-lock-name")?.blur();
            }
          }}
        >
          {parsedData.name}
      ...
      <div className="flex items-center gap-2">
        <button
          onClick={() => {
            document.getElementById("device-lock-name")?.focus();
          }}
        >
          Rename
        </button>
