  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-4xl mx-auto py-10 text-justify p-4 font-medium text-lg">
        ...
        <h2 className="py-2 font-semibold">1. Eligibility</h2>
        <div>
        ...
        <h2 className="py-2 font-semibold">2. Account Creation and Security</h2>
        <div>
        ...
        <h2 className="py-2 font-semibold">3. Use of Services</h2>
        <div>
          ...
          <br />a{")"} Violating any applicable laws, regulations, or
          third-party rights;
          <br />b{")"} Using our Services for any unlawful, fraudulent, or
          malicious purposes;
          <br />c{")"} Interfering with or disrupting the integrity, security,
          or performance of our Services;
          <br />d{")"} Accessing or attempting to access the accounts, systems,
          or networks of other users without authorization;
          <br />e{")"} Uploading, transmitting, or distributing any viruses,
          malware, or other harmful content;
          <br />f{")"} Engaging in any activity that could damage our reputation
        ...
        <h2 className="py-2 font-semibold">4. Intellectual Property Rights</h2>
        <div>
        ...
        <h2 className="py-2 font-semibold">5. Disclaimer of Warranties</h2>
        <div>
          ...
          accuracy, completeness, or reliability of any information or content
          provided through our Services. Your use of our Services is at your own
          risk.
        </div>

        <h2 className="py-2 font-semibold">6. Limitation of Liability</h2>
        <div>
        ...
        <h2 className="py-2 font-semibold">7. Indemnification</h2>
        <div>
